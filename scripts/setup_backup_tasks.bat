...
setlocal
set ROOT=%~dp0..
set DAILY_CMD="%ROOT%\scripts\backup_full_daily.bat"
set WEEKLY_CMD="%ROOT%\scripts\backup_full_daily.bat"

echo Creating/Updating scheduled tasks...
echo Target: D:\ScheduleOptimizer_Backups (or BACKUP_MIRROR_ROOT in .env)
...
echo Done.
echo Daily:  23:30  (DB + uploads to D:)
