...
> **مؤرشفة — 16 أغسطس 2026.** هذه الوثيقة قديمة وتناقض الكود الحالي (فيها «لا مصادقة ولا CSRF»).
> المصدر الحالي: [docs/ARCHITECTURE.md](docs/ARCHITECTURE.md) ومراجعة الأمن في المحادثة.
> لا تُنفَّذ توصيات القسم 1.1–1.3 من هنا دون التحقق من الكود.
